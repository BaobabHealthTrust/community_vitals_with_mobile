...
function receiveAjax(){
    // var result = ajaxGeneralRequestResult;
    
    var list = JSON.parse(ajaxGeneralRequestResult);
    var arr = [];

    for(var el = 0; el < list.length; el++){
        arr.push([list[el][0], list[el][1]]);
    }
...
function listFirstNames(fname){
    ...
    if(navigator.userAgent.toLowerCase().match(/android/)){
        ...
        ajaxGeneralRequest("/people/get_first_names?search=" + fname, "receiveAjax()");
    }
...
function listLastNames(lname){
    if(navigator.userAgent.toLowerCase().match(/android/)){
        ...
        ajaxGeneralRequest("/people/get_last_names?search=" + lname, "receiveAjax()");
    }
...
function getPeopleNames(fname, lname, gender){
    if(navigator.userAgent.toLowerCase().match(/android/)){
        ...
        ajaxGeneralRequest("/people/get_names?fname=" + fname + "&lname=" +
            lname + "&sex=" + gender, "receiveAjax()");
    }
...
function editPerson(id){
    window.location = "/people/edit_person?id=" + id;
}
...
function loadAllPeople(){
    ...
    if(navigator.userAgent.toLowerCase().match(/android/)){
        ...
        ajaxGeneralRequest("/people/load_all_people", "loadResult()");
    }
}
